...
cp -r \
$DATA_PATH"/interim/kbr_traffic_counts_temp/2-Pomiary nat®Ąenia ruchu drogowego/" \
$DATA_PATH/interim/
mv $DATA_PATH/interim/2-Pomiary\ nat®Ąenia\ ruchu\ drogowego/ $DATA_PATH/interim/kbr_traffic_counts
